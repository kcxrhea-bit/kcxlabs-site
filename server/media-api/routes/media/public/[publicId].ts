...
import { internalError, json, requestUrl, requireMethod, toNodeHandler } from "../../../_lib/http.js";
import { presignDownload, r2Context } from "../../../_lib/r2.js";
import { contentDispositionFor } from "../../../../../src/media/content.js";
import { resolveSharePageMode, toPublicMediaItem } from "../../../../../src/media/types.js";
...
async function handler(request: Request): Promise<Response> {
  ...
  try {
    const config = (await import("../../../_lib/config.js")).loadAppConfig();
  ...
  } catch (error) { return internalError(error, (await import("../../../_lib/config.js")).loadAppConfig()); }
}
