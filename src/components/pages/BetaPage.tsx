      ...
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-kcx-ash sm:text-lg">
            Early access build for invited KCx Labs testers on Windows 10/11 x64. This beta is for evaluation,
            feedback, and workflow validation before public release.
          </p>

          <div className="mt-8 grid gap-3 sm:grid-cols-3">
            <div className="micro-panel">
              <span className="block text-kcx-ash">Version</span>
              <span className="mt-2 block font-mono text-kcx-steel">0.9.0-beta.1</span>
            </div>
            <div className="micro-panel">
